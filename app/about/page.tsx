      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-[1220px] pb-[80px] lg:pb-[150px] px-[20px]">
          ...
          >
            ...
            <Link
              href={"/new"}
              className="text-black flex items-center px-[15px] lg:px-[20px] py-[10px] lg:py-[15px] rounded-[4px] text-[14px] lg:text-[20px] border-none bg-primary font-bold cursor-pointer"
            >
              ...
              >
                <Link className="cursor-pointer" href={`/new/${news.id}`}>
                  <img
                    ...
                    alt={news.title}
                  />
                  <div className="mt-[15px] lg:mt-[30px] text-[14px] lg:text-[18px]">
                    {news.date}
                  </div>
                  <div className="text-[18px] lg:text-[24px] font-bold truncate">
                    {news.title}
                  </div>
                </Link>
              </motion.div>
